package jieyi.accservice.config;
...
public class DataSourceConfig {
	...
	static final String PACKAGE = "jieyi.accservice.dao";

	private static final String MAPPER_LOCATION = "classpath:conf/mybatis/mapper/oracle/*.xml";
