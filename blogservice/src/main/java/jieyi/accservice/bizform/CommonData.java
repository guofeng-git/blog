...
public class CommonData implements Serializable {
    ...
    //62圈存
    private String trace_no;//系统跟踪号
    private String sysjounal;//前置系统流水号
    private String systradedate;//前置系统交易日期
    private String systradetime;//前置系统交易时间
    private String primary_acct_num;//主账号
    private String amt_trans;//交易金额
    private String date_settlmt;//清算日期
    private String retrivl_ref_num;//检索参考号
    private String card_accptr_termnl_id;//受卡机终端标识码
    private String icc_data;//ic卡数据域（对应银联标准中55域，下列都是其子域）
    private String sub_acct_bal;//补登账户余额
    private String sub_acct_txn_amt;//补登账户交易金额
    private String curr_code; //货币代码
    //62原交易信息
    private String orig_trans_type;//原交易类型
    private String orig_txn_date; //原交易日期
    private String orig_txn_time; //原交易时间
    private String orig_trace_no; //原交易流水号
    private String orig_txn_amt;  //原交易金额
    private String orig_merch_code;//原交易登录网点代码
    
    private String refundResult;  //退款结果
    /** 主账户二维码 **/
    private String qrcode;
    //互联网交易分页查询
    private String startNum;  //开始序号
    private String endNum;    //结束序号
    private String name;
	...
	public String getSysjounal() {
		return sysjounal;
	}
	public void setSysjounal(String sysjounal) {
		this.sysjounal = sysjounal;
	}
	public String getSystradedate() {
		return systradedate;
	}
	public void setSystradedate(String systradedate) {
		this.systradedate = systradedate;
	}
	public String getSystradetime() {
		return systradetime;
	}
	public void setSystradetime(String systradetime) {
		this.systradetime = systradetime;
	}
	...
	public String getSub_acct_bal() {
		return sub_acct_bal;
	}
	public void setSub_acct_bal(String sub_acct_bal) {
		this.sub_acct_bal = sub_acct_bal;
	}
	public String getSub_acct_txn_amt() {
		return sub_acct_txn_amt;
	}
	public void setSub_acct_txn_amt(String sub_acct_txn_amt) {
		this.sub_acct_txn_amt = sub_acct_txn_amt;
	}
	public String getOrig_trans_type() {
		return orig_trans_type;
	}
	public void setOrig_trans_type(String orig_trans_type) {
		this.orig_trans_type = orig_trans_type;
	}
	public String getOrig_txn_date() {
		return orig_txn_date;
	}
	public void setOrig_txn_date(String orig_txn_date) {
		this.orig_txn_date = orig_txn_date;
	}
	public String getOrig_txn_time() {
		return orig_txn_time;
	}
	public void setOrig_txn_time(String orig_txn_time) {
		this.orig_txn_time = orig_txn_time;
	}
	...
	public String getOrig_merch_code() {
		return orig_merch_code;
	}
	public void setOrig_merch_code(String orig_merch_code) {
		this.orig_merch_code = orig_merch_code;
	}
